...
public class PrefabPlacementEditor : Editor {
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.Slider(spread, 1, 1000, new GUIContent("Spread"));
        EditorGUILayout.Slider(radius, 1, 1000, new GUIContent ("Radius"));
    ...
    public void PrefabInstantiate (int index)
    {
        ...
        instanceOf.transform.rotation = new Quaternion (Random.Range(0,360),  Random.Range(0,360), Random.Range(0,360), Random.Range(0,360));
